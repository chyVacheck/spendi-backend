...
public enum ErrorCode {
	...
	// --- 403 FORBIDDEN ---
	ACCESS_DENIED("ACCESS_DENIED", HttpStatusCode.FORBIDDEN), ROLE_REQUIRED("ROLE_REQUIRED", HttpStatusCode.FORBIDDEN),
	...
	TOO_MANY_REQUESTS("TOO_MANY_REQUESTS", HttpStatusCode.TOO_MANY_REQUESTS),
